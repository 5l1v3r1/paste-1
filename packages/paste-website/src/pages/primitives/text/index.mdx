...
<ComponentHeader
  ...
  githubUrl="https://github.com/twilio-labs/paste/tree/master/packages/paste-core/primitives/text"
  storybookUrl="https://twilio-labs.github.io/paste/?path=/story/primitives-text--default"
